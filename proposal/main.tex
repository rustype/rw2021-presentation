...
to achieve such ambitious goal, Rust validates code with the borrow checker, which enforces memory safety rules.
...
while Rust has no direct support for typestates,
its type system is powerful enough to allow them to be implemented within it,
effectively mixing the line between specification and implementation by baking the possible state transitions in the type system.
...
% [3/1/2021]
% TODO [Move this paragraph up]
% NOTE [Is this actually necessary or could it be achieved in another way?]
